...
import com.gmail.kingarthuralagao.us.represent.databinding.FragmentRepresentatives2Binding
 ...
 */
class Representatives2Fragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(address : String) =
            Representatives2Fragment().apply {
    ...
    private lateinit var representativesBinding: FragmentRepresentatives2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        representativesBinding = FragmentRepresentatives2Binding.inflate(layoutInflater)
